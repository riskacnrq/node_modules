...
const PLATFORM_MAP = {
    'Mac OS': WAProto_1.proto.WebInfo.WebInfoWebSubPlatform.DARWIN,
    'Windows': WAProto_1.proto.WebInfo.WebInfoWebSubPlatform.WIN32
};
const getWebInfo = (config) => {
    let webSubPlatform = WAProto_1.proto.WebInfo.WebInfoWebSubPlatform.WEB_BROWSER;
...
const generateRegistrationNode = ({ registrationId, signedPreKey, signedIdentityKey }, config) => {
    ...
    const companion = {
        ...
        platformType: WAProto_1.proto.DeviceProps.DevicePropsPlatformType[config.browser[1].toUpperCase()]
            || WAProto_1.proto.DeviceProps.DevicePropsPlatformType.UNKNOWN,
